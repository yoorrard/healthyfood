  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
      <input
        ...
        className="flex-grow w-full px-5 py-3 text-lg border-2 border-gray-300 rounded-full focus:outline-none focus:ring-4 focus:ring-yellow-400 focus:border-yellow-500 transition-shadow duration-300 disabled:bg-gray-100"
        disabled={isLoading}
      />
      <button
        type="submit"
